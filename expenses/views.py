...
def expense_entry_create(request):
    ...
    if not request.user.is_superuser:
        try:
            ...
            return HttpResponseForbidden("Tài khoản này không được gán cho bất kỳ lái xe nào.")
    ...
    if request.method == "POST":
        ...
        if form.is_valid():
            ...
            print("Form errors:", form.errors)  # In lỗi form ra console
    else:
